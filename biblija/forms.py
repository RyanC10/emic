...
class FormaTEXT(forms.Form):
    ...
    mjerenje_15 = forms.CharField(max_length = 200,label=mark_safe('<strong>14.Bogataš iz Arabije koji je preživio teške patnje?</strong>'), initial='_ _ _ _ _')
    ...
    mjerenje_29 = forms.CharField(max_length = 200,label=mark_safe('<strong>28.Dijete kojem će ime biti Emanuel?</strong>'), initial='_ _ _ _ _')
